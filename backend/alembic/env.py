"""
Alembic ``env.py`` — configured for **async** migrations with pgvector.

Imports all NEXUS models so that ``Base.metadata`` is fully populated when
Alembic inspects the schema for auto-generation.
"""
